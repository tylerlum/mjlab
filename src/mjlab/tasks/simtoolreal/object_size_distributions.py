...
OBJECT_SIZE_DISTRIBUTIONS: List[ObjectSizeDistribution] = [
  ...
  # simple_cuboid — plain rectangular handle, no head.
  # length: 10–25 cm, width/height: 3–7 cm.
  # Use via: task.env.handleHeadTypes=[simple_cuboid,simple_cylinder]
  ObjectSizeDistribution(
    type="simple_cuboid",
    handle_min_lengths=(0.10, 0.03, 0.03),  # length, width, height (m)
    handle_max_lengths=(0.25, 0.07, 0.07),
    head_min_lengths=None,
    head_max_lengths=None,
    handle_min_density=LOW_DENSITY_MIN,
    handle_max_density=LOW_DENSITY_MAX,
  ...
  # simple_cylinder — plain cylindrical handle, no head.
  # length: 10–25 cm, diameter: 3–7 cm.
  ObjectSizeDistribution(
    type="simple_cylinder",
    handle_min_lengths=(0.10, 0.03),  # height, diameter (m)
    handle_max_lengths=(0.25, 0.07),
    head_min_lengths=None,
    head_max_lengths=None,
    handle_min_density=LOW_DENSITY_MIN,
    handle_max_density=LOW_DENSITY_MAX,
